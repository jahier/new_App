const Imagepath = {
    ...
    massage: require('../asstes/image/massage.png'),
    Vector1: require('../asstes/image/Vector(1).png'),
    Vector2: require('../asstes/image/Vector2.png'),
    ...
    Fill: require('../asstes/image/lodingimg.png'),
