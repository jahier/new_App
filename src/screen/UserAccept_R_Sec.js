...
const UserAccept_R_Sec = ({ navigation }) => {
    // button slect state
    ...
    const [isdate2, setisdate2] = useState("Slect Time")
    ...
    const handleConfirm2 = (date) => {
        // console.warn("A date has been picked: ", date);
        let dteformate2 = moment(new Date(date)).format('H-M-');
        setisdate2(dteformate2)
        hideDatePicker2();
    };
                ...
                <View style={styles.whiteConteant}>
                    ...
                    <View style={styles.mainShedualConteant}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: scale(15) }}>
                            <View style={{ width: '50%', }}>
                                <TouchableOpacity style={{
                                    width: '90%', height: heightPercentageToDP(5), borderRadius: scale(5),
                            ...
                            <View style={{ width: '50%', marginLeft: scale(10) }}>
                                <TouchableOpacity style={{
                                    ...
                                    justifyContent: 'center', backgroundColor: '#F7F7F7'
                                }} title="Show Date Picker" onPress={showDatePicker2} >
                                    <Text style={{ color: 'gray', marginLeft: widthPercentageToDP(3) }}>{isdate2}</Text>
                                </TouchableOpacity>
                                <DateTimePickerModal style={styles.datetime}
                                    ...
                                    value={DOB2}
                                    onChangeText={(text) => { setDOB2(text) }}
                                />
                            </View>
                        </View>
                        <Text style={styles.propsData}>Proposed alternative date</Text>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: scale(15) }}>
                            <View style={{ width: '50%', }}>
                                <TouchableOpacity style={{
                                    width: '90%', height: heightPercentageToDP(5), borderRadius: scale(10),
                            ...
                            <View style={{ width: '50%', marginLeft: scale(5) }}>
                                <TouchableOpacity style={{
                                    width: '90%', height: heightPercentageToDP(5), borderRadius: scale(10),
                                    justifyContent: 'center', backgroundColor: '#F7F7F7'
                                }} title="Show Date Picker" onPress={showDatePicker} >
                        ...
                        <View style={styles.btnConteant}>
                            <TouchableOpacity onPress={() => btnSlect('1')}
                                activeOpacity={0.5}
                                style={{
                                    width: '48%', backgroundColor: slect == '1' ? '#1478A8' : 'white',
                                    padding: scale(10), borderRadius: scale(5), alignSelf: 'center',
                                    borderWidth: 1, borderColor: slect == '2' ? '#1478A8' : '#1478A8'
                                }}>
                                <Text style={{ fontSize: scale(16), color: slect == '1' ? 'white' : '#1478A8', fontWeight: 'bold', textAlign: 'center', }}>Accept</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => btnSlect('2')}
                                activeOpacity={0.5}
                                style={{
                                    width: '48%', backgroundColor: slect == '2' ? '#1478A8' : 'white',
                                    padding: scale(10), borderRadius: scale(5), alignSelf: 'center',
                                    borderWidth: 1, borderColor: slect == '2' ? '#1478A8' : '#1478A8'
                                }}>
                                <Text style={{ fontSize: scale(16), color: slect == '2' ? 'white' : '#1478A8', fontWeight: 'bold', textAlign: 'center', }}>Reject</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    <View style={{ marginTop: scale(50) }}>
                        <Buttun
                            ...
                            onPress={() => navigation.navigate('Content_List')} />
                    </View>
...
export default UserAccept_R_Sec;
