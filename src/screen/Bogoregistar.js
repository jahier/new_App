                ...
                <View style={styles.inputvew}>
                    ...
                    <View style={{ marginTop: scale(40) }}>
                        <PhoneInput style={{ borderBottomWidth: 1, borderColor: '#130F26', }}
                            textContainerStyle={{ backgroundColor: '#ccc2', }}
                            containerStyle={{ backgroundColor: '#F7F7F7', width: '95%', elevation: 0, alignSelf: 'center', borderRadius: 6, height: 50, fontSize: 18 }}
