...
const Content_List = ({ navigation }) => {
    // flatlist data
    const data = [
        { contenerImg: Imagepath.ConteantWriter }, { contenerImg: Imagepath.ConteantWriter },
        { contenerImg: Imagepath.ConteantWriter }, { contenerImg: Imagepath.ConteantWriter },
        { contenerImg: Imagepath.ConteantWriter }, { contenerImg: Imagepath.ConteantWriter },
        { contenerImg: Imagepath.ConteantWriter }, { contenerImg: Imagepath.ConteantWriter },

    ]
    // slect date time pcker state
        ...
        return (
            <View>
                <View style={{ margin: scale(5) }}>
                    <Image style={{ resizeMode: 'contain' }} source={item.contenerImg} />
                </View>
            </View>
        )
    }
                ...
                <View style={styles.whiteConteant}>
                    ...
                    <View style={styles.mainShedualConteant}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: scale(10) }}>
                            ...
                            <Text style={styles.Waiting}>25 / 12 / 2022 at 8 PM</Text>
                        </View>
                    ...
                    <View style={styles.mainContentConteant}>
                        ...
                        <TouchableOpacity style={{ alignItems: 'center' }}>
                            <Text style={styles.Waiting}>Download all assets</Text>
                        </TouchableOpacity>
                    </View>
