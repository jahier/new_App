...
<View style={{marginTop:27,padding:3}}>
      ...
      <ScrollView style={styles.whitevew}>
        ...
        <View style={styles.cuntryoikrvew}>
          ...
          <PhoneInput style={{ borderBottomWidth: 1, marginTop: 30, }}
            textContainerStyle={{ backgroundColor: '#F7F7F7', borderRadius: 5 }}
            containerStyle={{ backgroundColor: '#F7F7F7', width: '98%', elevation: 0, alignSelf: 'center', borderRadius: 5, height: 50, fontSize: 18, marginTop: 10 }}
